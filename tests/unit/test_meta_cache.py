...
class TestThreadSafety:
    ...
    def test_concurrent_reads_safe(self, mock_extract):
        ...
        # Prepopulate cache
        cache_data = {
            'product.nc': mock_extract.return_value
        }
...
class TestIntegrationWithGDAL:
    ...
    @pytest.mark.skipif(
        not os.path.exists('/usr/bin/gdal_translate'),
    ...
    def test_extract_metadata_real_file(self, tmp_path):
        ...
        ds = driver.Create(
            str(test_file), 100, 100, 1, gdal.GDT_Byte
        )
