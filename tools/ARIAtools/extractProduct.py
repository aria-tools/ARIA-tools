...
def tropo_correction(full_product_dict, tropo_products, bbox_file, prods_TOTbbox, dem=None, lat=None, lon=None, mask=None, outDir='./',outputFormat='VRT', verbose=None):
    """
...
def main(inps=None):
    ...
    if inps.tropo_products:
        tropo_correction(standardproduct_info.products, inps.tropo_products, standardproduct_info.bbox_file, prods_TOTbbox, dem=demfile, lat=Latitude, lon=Longitude, mask=inps.mask, outDir=inps.workdir, outputFormat=inps.outputFormat, verbose=inps.verbose)
